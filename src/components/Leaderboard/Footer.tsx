...
const Footer = () => {
  return (
    <div className={clsx(
      ...
      <div>
        <p className="text-caption text-text-200 dark:text-text-400 font-medium">
          Showing
  ...
  return (
    <Button
      className={clsx(
        ...
        'w-5 h-5',
        isActive
          ? 'bg-[#F0F0F5] dark:bg-surface-300 text-text-400 dark:text-text-100 font-medium'
          : 'bg-transparent text-text-200 dark:text-text-500 font-bold',
        className
      )}
      onClick={onClick}
    >
...
const PrevButton = () => {
  return (
    <Button className="pr-4 border-r border-r-divider-light-400 dark:border-r-divider-500">
      {() => (
...
const NextButton = () => {
  return (
    <Button className="pl-4 border-l border-l-divider-light-400 dark:border-l-divider-500">
      {() => (
        <svg className="stroke-[#999AA9] dark:stroke-[#4C4D5F]" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
